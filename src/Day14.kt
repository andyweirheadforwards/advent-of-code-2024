...
fun RobotListString.toRobotList(tiles: Pair<Int, Int>): RobotList = trim().lines().map { Robot(it, tiles) }
...
data class Restroom(
    ...
    companion object {
        ...
        ): Restroom = Restroom(tiles, string.toRobotList(tiles))
    }
...
data class Robot(
    ...
    companion object {
        ...
        operator fun invoke(
            ...
            vY: Int,
            tiles: Pair<Int, Int>,
        ): Robot = Robot(Point(pX, pY), Point(vX, vY), tiles)
