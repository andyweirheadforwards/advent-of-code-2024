...
fun PatrolMap.isObstruction(point: Point) = getSymbolAt(point) in listOf(OBSTRUCTION, NEW_OBSTRUCTION)
...
fun PatrolMap.countLoopObstructionLocations(): Int =
    runBlocking {
